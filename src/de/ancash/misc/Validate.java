...
public class Validate {
	...
	/**
	 * <p>
	 * Validate that the argument condition is <code>true</code>; otherwise throwing
	 * an exception with the specified message. This method is useful when
	 * validating according to an arbitrary boolean expression, such as validating
	 * an object or using your own custom validation expression.
	 * </p>
	 *
	 * <pre>
	 ...
	 *
	 * <p>
	 * For performance reasons, the object value is passed as a separate parameter
	 ...
	 * <p>
	 * Validate that the argument condition is <code>true</code>; otherwise throwing
	 * an exception. This method is useful when validating according to an arbitrary
	...
	/**
	 * <p>
	 * Validate that the specified argument array is neither <code>null</code> nor a
	...
	/**
	 * <p>
	 * Validate that the specified argument collection is neither <code>null</code>
	 * nor a size of zero (no elements); otherwise throwing an exception with the
	 * specified message.
	 *
	 * <pre>
	...
	/**
	 * <p>
	 * Validate that the specified argument map is neither <code>null</code> nor a
	...
	/**
	 * <p>
	 * Validate that the specified argument string is neither <code>null</code> nor
	 * a length of zero (no characters); otherwise throwing an exception with the
	 * specified message.
	 *
	 * <pre>
	...
	/**
	 * <p>
	 * Validate that the specified argument array is neither <code>null</code> nor
	 * contains any elements that are <code>null</code>; otherwise throwing an
	 ...
	 *
	 * @param array   the array to check
	 * @param message the exception message if the collection has <code>null</code>
	 *                elements
	 * @throws IllegalArgumentException if the array is <code>null</code> or an
	 *                                  element in the array is <code>null</code>
	 */
	 ...
	 * <p>
	 * Validate that the specified argument collection is neither <code>null</code>
	 * nor contains any elements that are <code>null</code>; otherwise throwing an
	 * exception with the specified message.
	 *
	 * <pre>
	 ...
	 *
	 * <p>
	 * If the collection is <code>null</code>, then the message in the exception is
	 * &quot;The validated object is null&quot;.
	 * </p>
	 *
	 * @param collection the collection to check
	 * @param message    the exception message if the collection has
	 * @throws IllegalArgumentException if the collection is <code>null</code> or an
	 ...
	 *
	 * <p>
	 * If the collection has a <code>null</code> element, then the message in the
	...
	/**
	 * <p>
	 * Validate an argument, throwing <code>IllegalArgumentException</code> if the
	 * argument collection is <code>null</code> or has elements that are not of type
	 * <code>clazz</code> or a subclass.
	 * </p>
	 *
	 * <pre>
	 ...
	 *
	 * <p>
	 * The message in the exception is 'The validated collection contains an element
	 * not of type clazz at index: '.
	 * </p>
	 *
	 * @param collection the collection to check, not null
	 * @param clazz      the <code>Class</code> which the collection's elements are
